...
<footer class="footer d-print-none py-1 mt-auto site-footer fixed-bottom-md">
	<div class="collapse row" id="collapseLang">
		<div class="col justify-content-right">
			<?php
			$tag1='<img class="newLang flag-img float-end" src="locale/flags/';
			$tag2='.png">';
	...
	<div class="row ">
		<div class="col ">
			<a class="footer-link" href="?create=1"><span class="text-muted ms-2">&copy; Stavekontrolden</span></a>
		</div>
		<div class="col-md-7 col-5 d-flex justify-content-center">
			<a class="footer-link text-center me-3 me-lg-4 d-none d-md-inline" href="?cookies=1"><?= _('Cookies');?></a>
			<a class="footer-link text-center me-3 me-lg-4 d-none d-md-inline" href="?contact=1"><?= _('Contact');?></a>
		</div>
		<div class="col">
			<div  class="icon-link float-end" id="chooselang"><span><button class="btn pb-0 pt-0 "><img data-bs-toggle="collapse" href="#collapseLang" role="button" aria-expanded="false" aria-controls="collapseLang" class="flag-img" src="locale/flags/<?= $locale; ?>.png"></button></div>

			<?php if($_SESSION["user_id"]) {?><form method="POST" action="?<?=$_SERVER['QUERY_STRING'];?>"><button class="btn pb-0 pt-0 text-muted float-end logout" onclick="this.form.submit()" title="<?= _('Log out');?>"><i class="fas fa-sign-out-alt"></i></button><input type="hidden" name="logout" value="true"></form><?php } ?>
		</div>
	</div>
	<div class="row ">
		<div class="col d-flex justify-content-center">
			<a class="footer-link text-center me-3 me-lg-4 d-md-none" href="?cookies=1"><?= _('Cookies');?></a>
			<a class="footer-link text-center me-3 me-lg-4 d-md-none" href="?contact=1"><?= _('Contact');?></a>
			<a class="footer-link text-center ms-3 ms-lg-4 d-md-none" href="./?backend=1"><?= _('Log in');?></a>
		</div>
	</div>
...
<div class="alert alert-warning" id="stavekontroldenWarning" style="position: fixed;width:30%;z-index:1051;top:50%;left:50%;margin-left:-15%;text-align:center;display:none; " role="alert">
	<button type="button" class="btn-close" id="closew" aria-label="Close" >
...
<div class="alert alert-success" id="stavekontroldenMessage" style="position: fixed;width:30%;z-index:1051;top:50%;left:50%;margin-left:-15%;text-align:center;display:none; " role="alert">
	<button type="button" class="btn-close" id="closem" aria-label="Close">
		<span aria-hidden="true">&times;</span>
	</button>
...
<div class="alert alert-danger fixed-bottom w-100" id="stavekontroldenError" style="position: fixed;z-index:1051;text-align:center;display:none; margin-bottom:0px;padding-x:30px;" role="alert">
	<button type="button" class="btn-close" id="closee" aria-label="Close" >
		<span aria-hidden="true">&times;</span>
	</button>
