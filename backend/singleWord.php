...
#$res=array();
$cols='`id`,`word`,`wordstatus`,`wordclass`,`strong_declension`,`misspellings`,`fugeelementid`,`word_definition`,`comments`,`technical_term`,`log`,`contributor`,`lastuser`,`omitsuggestion` ';
