...
if($_POST["inviteuser"]) {
	$q='update users set org_id="'.$org_id.'" where email="'.$_POST["inviteuser"].'" or username="'.$_POST["inviteuser"].'"';
}
if($_POST["create"]) {
...
} else $res["warning"]=_("Wrong command").print_r($_POST,true);// $log.=$q;
$res["log"]=$log;
